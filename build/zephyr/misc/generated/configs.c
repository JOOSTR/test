...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32U5_OTGHS_PHY_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 139);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_U5A5ZJ_Q, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_U5A5ZJ_Q_STM32U5A5XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32U5A5XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 2496);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SDMMC_STM32_CLOCK_CHECK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UDC_BUF_POOL_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_MSC_LUNS_PER_INSTANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_MSC_SCSI_BUFFER_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_MSC_DOUBLE_BUFFERING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_MSC_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USBD_MSC_LOG_LEVEL, 4);
