...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8000000 + 0x0), LENGTH = (4096 * 1024 - 0x0 - 0x0)
    RAM (wx) : ORIGIN = 0x20000000, LENGTH = (2496 * 1K)
    SRAM0 ( rw ) : ORIGIN = (536870912), LENGTH = (2555904)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = 0x20000000 + (2496 * 1K);
